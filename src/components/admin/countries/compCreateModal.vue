  ...
  >
    <div class="modal-dialog">
      <div v-if="isCreateAlert" class="alert alert-success">
        ...
        <p style="font-size: 14px">Thêm mới một quốc gia phim thành công</p>
      </div>
      <div class="alert alert-danger" v-if="isCreateError">
        <h5 class="fw-bold">Thông báo!</h5>
        <p style="font-size: 14px">Thêm quốc gia phim không thành công</p>
        <p style="font-size: 14px">Tên quốc gia đã tồn tại</p>
      </div>
